...
try {
    ...
    child_process.execFileSync(sshAddCmd, ['-L']).toString().trim().split(/\r?\n/).forEach(function(key) {
        ...
        console.log(`exec: ${gitCmd} config --global --add url."git@key-${sha256}.github.com:${ownerAndRepoGit}".insteadOf "ssh://git@github.com/${ownerAndRepoGit}"`);
        child_process.execSync(`${gitCmd} config --global --add url."git@key-${sha256}.github.com:${ownerAndRepoGit}".insteadOf "ssh://git@github.com/${ownerAndRepoGit}"`);
